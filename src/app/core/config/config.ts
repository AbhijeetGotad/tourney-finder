export class Config {
  ...
  public static domainUrl = "http://hrplatformdev.ril.com";
  ...
  public static baseUrl = "http://hrplatformdev.ril.com" + '/api/';
  ...
  public static pwdRegex = '(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@!%*?&#^])(?!.* ).{8,16}';
  public static domainRegex = '^[a-zA-Z0-9]{1,24}$'
